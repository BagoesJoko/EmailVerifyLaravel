      ...
      <div class="mx-auto content max-w-screen-xl px-4 py-32 lg:flex lg:h-screen lg:items-center">
        <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
          <div class="mx-auto max-w-lg bg-gray-700 rounded-lg shadow-lg">
            <form method="POST" action="{{ route('login') }}" class="mb-0 mt-6 space-y-4 rounded-lg p-4 shadow-lg sm:p-6 lg:p-5">
                @csrf
              <h1 class="text-center text-white font-medium">Sign in to your account</h1>
              <div>
              ...
              <p class="text-center text-sm text-gray-500">
               ...
               @if (Route::has('password.request'))
                  <p class="text-center text-sm text-gray-500">
                    Forgot
                    <a class="underline" href="{{ route('password.request') }}">Your Password?</a>
                  </p>
               @endif
            </form>
          </div>
