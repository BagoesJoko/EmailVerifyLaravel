      ...
      <div class="mx-auto content max-w-screen-xl px-4 py-32 lg:flex lg:h-screen lg:items-center">
        <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
          <div class="mx-auto max-w-lg bg-gray-700 rounded-lg shadow-lg">
            <form method="POST" action="{{ route('register') }}" class="mb-0 mt-6 space-y-4 rounded-lg p-4 shadow-lg sm:p-6 lg:p-5">
                @csrf
              <h1 class="text-center text-white font-medium">Register Your Account</h1>
              <div>
                ...
                <div class="relative">
                  <input
                    ...
                    id="name"
                    name="name"
                    class="w-full rounded-lg border-gray-200 p-4 pe-12 text-sm shadow-sm form-control @error('name') is-invalid @enderror"
              ...
              <div>
                ...
                <div class="relative">
                  <input
                    ...
                    placeholder="Enter password" required autocomplete="current-password" required autocomplete="current-password"/>
                    @error('password')
                        <span class="invalid-feedback" role="alert">
                            <small class="text-pink-400">{{ $message }}</small>
                        </span>
              ...
              <p class="text-center text-sm text-gray-500">
                Have account?
                <a class="underline" href="{{ url('/login') }}">Sign In</a>
              </p>
            </form>
          </div>
        </div>
